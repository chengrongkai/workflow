...
import com.tj720.config.UserConfig;
import com.tj720.config.WfUserAop;
import com.tj720.entity.buissness.inter.UserObject;
...
public class WfUserAopAspect {
    ...
    @Pointcut("@annotation(com.tj720.config.WfUserAop)")
