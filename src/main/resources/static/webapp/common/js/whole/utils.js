...
(function ($, window) {
    ...
    window.$t.goToPage=function(obj,back,callback) {
        ...
        if (parent.$("#navTab").find("li[data-url='" + url + "']").length === 0) {
            ...
            //新增tab页
            var _li = '<li class="layui-this main-tab" style="width:100%" data-url="' + url + '">'+"<span style='float:left' id='pageTitle'>"+name+"</span>"+"<span style='float:right' class='myRefresh'><i class=\"layui-icon layui-icon-left\"></i>返回</span>"+ '</li>';
    ...
    window.$t.goToPageSimple=function(url,name,back) {
        ...
        if (parent.$("#navTab").find("li[data-url='" + url + "']").length === 0) {
            ...
            //$("#navTab").find("li").removeClass("layui-this");
            //新增tab页
            var _li = '<li class="layui-this main-tab" style="width:100%" data-url="' + url + '">'+"<span style='float:left' id='pageTitle'>"+name+"</span>"+"<span style='float:right' class='myRefresh'><i class=\"fa fa-refresh\">&nbsp;</i>返回</span>"+ '</li>';
            parent.$("#navTab").find("ul").empty().append(_li);
